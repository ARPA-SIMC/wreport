...
public:
    ...
    BufrTableID() {}
    BufrTableID(uint16_t originating_centre, uint16_t originating_subcentre,
    ...
    int closest_match(const BufrTableID& first,
                      const BufrTableID& second) const;
    int closest_match(const CrexTableID& first,
...
public:
    ...
    CrexTableID() {}
    CrexTableID(uint8_t edition_number, uint16_t originating_centre,
                uint16_t originating_subcentre, uint8_t master_table_number,
                uint8_t master_table_version_number,
