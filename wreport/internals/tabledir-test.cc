...
void Tests::register_tests()
{
    ...
    add_method("override_unchanged", [] {
        ...
        options::LocalOverride o(options::var_master_table_version_override,
        ...
        const tabledir::CrexTable* ct =
            dynamic_cast<const tabledir::CrexTable*>(t);
    ...
    add_method("override_crex_with_value", [] {
        ...
        const tabledir::Table* t =
            td.find_crex(CrexTableID(1, 0, 0, 0, 0, 0, 0));
        wassert_true(t != 0);
        const tabledir::CrexTable* ct =
            dynamic_cast<const tabledir::CrexTable*>(t);
        wassert_true(ct != 0);
    ...
    add_method("tabledir_crex_old", []() {
        auto& td = tabledir::Tabledirs::get();
        const tabledir::Table* t =
            td.find_crex(CrexTableID(1, 0, 0, 0, 3, 0, 0));
        wassert(actual(t != 0).istrue());
        const tabledir::CrexTable* ct =
            dynamic_cast<const tabledir::CrexTable*>(t);
