...
struct VarBenchmark : Benchmark
{
    ...
    void setup_main()
    {
        ...
        varinfo_int.set_bufr(WR_VAR(0, 0, 0), "test integer variable", "number", 0, 10, 0, 0, 10);
        varinfo_double.set_bufr(WR_VAR(0, 0, 0), "test double variable", "number", 5, 10, 5, -100000, 10);
