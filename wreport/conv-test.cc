...
class Tests : public TestCase
{
    ...
    void register_tests() override
    {
        add_method("units", []() {
            ...
            wassert(
                actual(convert_units("C", "K", 0.7)).almost_equal(273.85, 4));
            ...
            wassert(actual(convert_units("ug/m**3", "KG/M**3", 45))
                        .almost_equal(4.5e-08, 10));
            wassert(actual(convert_units("KG/M**3", "ug/m**3", 0.000000051))
                        .almost_equal(51.0, 10));
            ...
            wassert(actual(convert_units("km/h", "M/S", 3.6)) == 1);
        });
        add_method("vss", []() {
            // Vertical sounding significance conversion functions
            wassert(actual(convert_BUFR08001_to_BUFR08042(
                        BUFR08001::ALL_MISSING)) == BUFR08042::ALL_MISSING);
            wassert(actual(convert_BUFR08001_to_BUFR08042(BUFR08001::TROPO)) ==
                    BUFR08042::TROPO);
            wassert(actual(convert_BUFR08001_to_BUFR08042(BUFR08001::SIGTH)) ==
                    (BUFR08042::SIGTEMP | BUFR08042::SIGHUM));

            wassert(actual(convert_BUFR08042_to_BUFR08001(
                        BUFR08042::ALL_MISSING)) == BUFR08001::ALL_MISSING);
            wassert(actual(convert_BUFR08042_to_BUFR08001(BUFR08042::TROPO)) ==
                    BUFR08001::TROPO);
            wassert(actual(convert_BUFR08042_to_BUFR08001(
                        BUFR08042::SIGTEMP)) == BUFR08001::SIGTH);
            wassert(actual(convert_BUFR08042_to_BUFR08001(BUFR08042::SIGHUM)) ==
                    BUFR08001::SIGTH);
        });
        add_method("octants", []() {
