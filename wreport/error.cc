...
const char* error::strerror(ErrorCode code) { return err_desc[code]; }
...
static std::string build_parse_error(const char* file, int line,
...
static std::string build_regexp_error(int code, void* re,
                                      const std::string& msg)
{
    char details[512];
