...
template <typename Bltn> struct TestData
{
    string fname;
    string data;
    ...
    TestData(TestData&& o)
        : fname(move(o.fname)), data(move(o.data)),
          head_bulletin(o.head_bulletin), data_bulletin(o.data_bulletin)
    {
...
void load(const char* msgdir, vector<TestData<Bltn>>& out,
...
struct BulletinBenchmark : Benchmark
{
    ...
    BulletinBenchmark(const std::string& name)
        : Benchmark(name), decode_bufr_head(this, "decode_bufr_head"),
          decode_bufr(this, "decode_bufr"),
          decode_crex_head(this, "decode_crex_head"),
          decode_crex(this, "decode_crex"), encode_bufr(this, "encode_bufr"),
          encode_crex(this, "encode_crex")
    {
    ...
    void setup_main()
    {
        ...
        load<BufrBulletin>(
            "bufr", bufr_data,
            {"airep-old-4-142.bufr",
             "A_ISMN02LFPW080000RRA_C_RJTD_20140808000319_100.bufr",
             "ascat1.bufr",
             "atms1.bufr",
             "atms2.bufr",
             "bufr1",
             ...
             "C23000-1.bufr",
             "C23000.bufr",
             "ed4-compr-string.bufr",
             "ed4date.bufr",
             "ed4-empty.bufr",
             "ed4-parseerror1.bufr",
             "gps_zenith.bufr",
             "gts-buoy1.bufr",
             "gts-synop-rad1.bufr",
             "gts-synop-rad2.bufr",
             "gts-synop-tchange.bufr",
             "new-003.bufr",
             "noassoc.bufr",
             "obs0-1.11188.bufr",
             "obs0-1.22.bufr",
             ...
             "obs4-144.4.bufr",
             "obs4-145.4.bufr",
             "synop-cloudbelow.bufr",
             "synop-evapo.bufr",
             "synop-groundtemp.bufr",
             "synop-longname.bufr",
             "synop-oddgust.bufr",
             "synop-oddprec.bufr",
             "synop-old-buoy.bufr",
             ...
             "test-soil1.bufr",
             "test-temp1.bufr"});
        load<CrexBulletin>("crex", crex_data,
                           {"test-mare0.crex", "test-mare1.crex",
                            "test-mare2.crex", "test-synop0.crex",
                            "test-synop1.crex", "test-synop2.crex",
                            "test-synop3.crex", "test-temp0.crex"});
    }
