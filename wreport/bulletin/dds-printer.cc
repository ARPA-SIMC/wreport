...
const Var& DDSPrinter::define_bitmap(Varcode code, Varcode rep_code, Varcode delayed_code, const Opcodes& ops)
{
    const Var& res = BaseParser::define_bitmap(code, rep_code, delayed_code, ops);
    if (delayed_code)
    {
